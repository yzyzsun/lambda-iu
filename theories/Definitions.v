(* generated by Ott 0.34 from: lambda-iu.ott *)
...
Definition var : Set := nat. (* variable/label *)

Inductive typ : Set :=  (* types *)
 | t_top : typ (* top type *)
 | t_bot : typ (* bottom type *)
 | t_null : typ (* null type *)
 | t_int : typ (* integer type *)
 | t_arrow (A:typ) (B:typ) (* function type *)
 | t_rcd (l:var) (A:typ) (* record type *)
 | t_and (A:typ) (B:typ) (* intersection type *)
 | t_or (A:typ) (B:typ) (* union type *).

Inductive exp : Set :=  (* expressions *)
 | e_top : exp (* top value *)
 | e_null : exp (* null value *)
 | e_int : exp (* integer literal *)
 | e_var (x:var) (* variable *)
 | e_abs (x:var) (A:typ) (e:exp) (B:typ) (* abstraction *)
 | e_app (e1:exp) (e2:exp) (* application *)
 | e_rcd (l:var) (A:typ) (e:exp) (* record *)
 | e_prj (e:exp) (l:var) (* projection *)
 | e_merge (e1:exp) (e2:exp) (* merging *)
 | e_switch (e0:exp) (x:var) (A:typ) (e1:exp) (B:typ) (e2:exp) (* type switch *)
 | e_letin (letin5:letin) (e:exp)
with letin : Set :=  (* let-in bindings *)
 | letin_identity : letin
 | letin_composition (letin5:letin) (letin':letin)
 | letin_bind (x:var) (e:exp).

Inductive styp : Set :=  (* source types *)
 | st_int : styp (* integer type *)
 | st_arrow (As:styp) (Bs:styp) (* function type *)
 | st_narrow (P:nptyp) (Bs:styp) (* function type with named parameters *)
 | st_narg (T:natyp) (* named argument type *)
with nptyp : Set :=  (* named parameter types *)
 | pt_empty : nptyp (* empty *)
 | pt_required (P:nptyp) (l:var) (As:styp) (* required parameter *)
 | pt_optional (P:nptyp) (l:var) (As:styp) (* optional parameter *)
with natyp : Set :=  (* named argument types *)
 | at_empty : natyp (* empty *)
 | at_field (T:natyp) (l:var) (As:styp) (* field *).

Definition ctx : Set := list (nat * typ).

Definition sctx : Set := list (nat * styp).

Inductive naexp : Set :=  (* named arguments *)
 | arg_empty : naexp (* empty *)
 | arg_field (a:naexp) (l:var) (es:sexp) (* field *)
with sexp : Set :=  (* source expressions *)
 | se_int : sexp (* integer literal *)
 | se_var (x:var) (* variable *)
 | se_abs (x:var) (As:styp) (es:sexp) (* abstraction *)
 | se_nabs (p:npexp) (es:sexp) (* abstraction with named parameters *)
 | se_app (es1:sexp) (es2:sexp) (* application *)
 | se_narg (a:naexp) (* named arguments *)
with npexp : Set :=  (* named parameters *)
 | par_empty : npexp (* empty *)
 | par_required (p:npexp) (l:var) (As:styp) (* required parameter *)
 | par_optional (p:npexp) (l:var) (es:sexp) (* optional parameter *).
